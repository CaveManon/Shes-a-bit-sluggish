...
label firstQuestionConvergance:
...
"Andrew then realized he is profoundly fucking retarded."
...
"Her antennae things brush lightly against the side of my head, creating a tingling static in my ear."
...
A "I can’t remember shit from any of this, just the character design from the deepest darks of the deep-darks, and characters that have the same charm as someone shitting on sandpaper and rubbing it on your brand new sports car."  
...
A "I am tempted to watch it again, write an entire novel about how bad it is, and then blow my fucking brains out." 


A "This was the worst shit I’ve ever seen."
...
A "Your roommate’s a colossal bitch, Dori."


A "She’s clearly put you through this bullshit before and probably isn’t going to stop soon."
...
if score == 3: #The Good Ending
    ...
    "Her fingers intermingle with mine."

    "The feeling of our palms pressing together sending a current of static up my arms, lighting a spark in my chest."    
    D "I uh… is this..?"
    ...
    "Each slap echoes off my metal chest, each thump reciprocated by my heart’s beat."
    ...
    if os.path.isfile('Bad') and os.path.isfile('Neutral') and os.path.isfile('Good'): #The Secret Ending
          ...
          "And a whole lot of other experiences too."
           
          scene yourcoombait with fade           
